...
#####################################################################
# 2. githubWithTests: get data from the OWID covid.ourworldindata website
#####################################################################

# (2021) link https://covid.ourworldindata.org/data/owid-covid-data.json
# recommended but does not allow wget
# (2022-01-18) update: Now wget works and other github link dead
...
#  wget https://raw.githubusercontent.com/owid/covid-19-data/master/public/data/owid-covid-data.json --output-document=data/githubWithTests.json
  wget https://covid.ourworldindata.org/data/owid-covid-data.json --output-document=data/githubWithTests.json
...
#####################################################################
# 4. Include separate source with ICUs and other illness data in
