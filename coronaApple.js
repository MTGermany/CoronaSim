...
function startup() {
  ...
  // =============================================================
  dataGitLocal='{ "Afghanistan": [  {  "date": "2020-1-22",  "confirmed": 0, "deaths": 0, "recovered": 0}]}';
  var mydata = JSON.parse(data);
  var mydataGit = JSON.parse(dataGitLocal);
  console.log("mydataGit=",mydataGit);
  ...
  if(!useGithubData){corona.init();} // !!! now inside fetch promise
